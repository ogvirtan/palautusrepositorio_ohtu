...
def main():
    ...
    while True:
        season = Prompt.ask(f"[grey69]Seasons [magenta][{'/'.join(seasons)}][/magenta][cyan]()[/cyan][/grey69]")
        ...
        console.print(f"[grey69]Seasons [magenta][{'/'.join(seasons)}][/magenta][cyan]({season})[/cyan]:[/grey69]")

        while True:  
            nationalities = reader.get_nationalities()
            nationality = Prompt.ask(f"[grey69]Nationality [magenta][{'/'.join(nationalities)}][/magenta][cyan]()[/cyan][/grey69]").upper()
